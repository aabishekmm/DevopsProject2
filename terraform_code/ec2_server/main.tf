...
resource "aws_instance" "my-ec2" {
  ...
  # Attach the SSM instance profile so the SSM agent can register automatically
  ...
  # Provision using cloud-init (user_data) instead of remote-exec to make provisioning robust
